...
const chapter3: Chapter = {
  ...
  sentences: [
    { id: 's1', english: 'What is your name?', syllables: [{ hanzi: '你', pinyin: 'nǐ' }, { hanzi: '叫', pinyin: 'jiào' }, { hanzi: '什', pinyin: 'shén' }, { hanzi: '么', pinyin: 'me' }, { hanzi: '名', pinyin: 'míng' }, { hanzi: '字', pinyin: 'zi' }, { hanzi: '？', pinyin: '' }] },
    { id: 's2', english: 'I am a teacher.', syllables: [{ hanzi: '我', pinyin: 'wǒ' }, { hanzi: '是', pinyin: 'shì' }, { hanzi: '老', pinyin: 'lǎo' }, { hanzi: '师', pinyin: 'shī' }, { hanzi: '。', pinyin: '' }] },
    { id: 's3', english: 'Are you a student?', syllables: [{ hanzi: '你', pinyin: 'nǐ' }, { hanzi: '是', pinyin: 'shì' }, { hanzi: '学', pinyin: 'xué' }, { hanzi: '生', pinyin: 'sheng' }, { hanzi: '吗', pinyin: 'ma' }, { hanzi: '？', pinyin: '' }] },
  ],
};
